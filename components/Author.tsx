...
export default function Author({ info }: Props) {
  return (
    <address className="hidden px-4 pt-4 not-italic dark:relative dark:after:absolute dark:after:inset-0 dark:after:-z-10 dark:after:bg-neutral-800 dark:after:opacity-90 laptop:block laptop:px-8 laptop:pt-8">
